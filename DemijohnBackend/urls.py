...
urlpatterns = [
    ...
    path("get_recurring_order_type/", views.get_recurring_order_type),
    path("change_recurring_order_type/", views.change_recurring_order_type),
    path("cancel_recurring_order/", views.cancel_recurring_order)
]
